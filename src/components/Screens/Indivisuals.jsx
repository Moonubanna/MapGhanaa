...
export default class Indivisuals extends React.PureComponent {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        console.log('componentDidMount of Indivisuals screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of Indivisuals screen')
    }
