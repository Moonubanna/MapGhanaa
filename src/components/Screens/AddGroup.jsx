...
export default class AddGroup extends React.PureComponent {
    ...
    componentDidMount() {
        console.log('componentDidMount of AddGroup screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of AddGroup screen')
    }
        ...
        return (
            <View style={{
                ...
                <ScrollView style={{
                    ...
                    >{translate('GROUP_CHAT_LINK')}</Text>
                    ...
                    />
                    <View style={{display:'flex',marginTop:5,flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                    <Text
                        style={{
                            fontFamily: FONT_FAMILIY.Font_Regular,
                            borderRadius: 4,
                    ...
                    >{translate('PASSWORD_PROTECTED')}</Text>
