...
export default class PostListing extends React.PureComponent {
    ...
    componentDidMount() {
        console.log('componentDidMount of PostListing screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of PostListing screen')
    }
                ...
                <ScrollView style={{
                    ...
                    <View style={{
                        ...
                        <View style={{ display: 'flex' }}>
                            ...
                            <View style={{ display: 'flex', marginTop: 10, paddingHorizontal: 10, borderRadius: 3, paddingVertical: 40, backgroundColor: colors.green600, justifyContent: 'center', alignItems: 'center' }}>
                                <IconX
