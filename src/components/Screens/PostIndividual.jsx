...
export default class PostIndividual extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
            showDropDown: false,
    ...
    componentDidMount() {
        console.log('componentDidMount of PostIndividual screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of PostIndividual screen')
    }
